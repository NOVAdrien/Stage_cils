# models/passive_chain_friction_with_activation.py
...
class PassiveChainFrictionWithActivation(BaseSystem):
    """
    ...
    def __init__(self, N, masses, lengths, widths, stiffnesses, amplitudes, omega, k_spatial, phi, alpha, gamma, initial_conditions):
        ...
        rhs_no_friction_and_activation = self.LM.rhs()

        # On ajoute les frottements :
        rhs_with_friction_and_activation = ajoute_frottements_au_rhs(rhs_no_friction_and_activation, self.Q_non_cons, self.M_list, self.N)
        ...
        self._rhs_func = sp.lambdify(args, rhs_with_friction_and_activation)
    ...
    def _build_rhs_with_friction_and_activation(self):
